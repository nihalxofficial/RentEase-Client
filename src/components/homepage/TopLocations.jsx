...
export default function TopLocations({
  ...
  locations = [
    ...
    },
    {
      ...
      name: "Los Angeles",
      state: "CA",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Los_Angeles_with_Mount_Baldy.jpg/330px-Los_Angeles_with_Mount_Baldy.jpg",
      properties: 980,
      slug: "los-angeles",
    },
    {
    ...
    },
    {
      ...
      name: "Miami",
      state: "FL",
      image: "https://cdn.getyourguide.com/image/format=auto,fit=crop,gravity=auto,quality=60,width=400,height=265,dpr=2/tour_img/61e5f27c09bd6.jpeg",
      properties: 650,
      slug: "miami",
    },
    {
      ...
      name: "Seattle",
      state: "WA",
      image: "https://www.kayak.com/rimg/dimg/dynamic/376-1685672768-seattle_introduction_intro_image_3_gettyimages-95761249-scaled.jpeg?height=768&width=1366&crop=true",
      properties: 540,
      slug: "seattle",
    },
    {
      ...
      name: "Austin",
      state: "TX",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzm23r2__LhuZ3NbYqIZ6Q0hP7tV2JBTwTAg&s",
      properties: 480,
      slug: "austin",
    },
  ],
